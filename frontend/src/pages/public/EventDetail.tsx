    ...
    <section className="min-h-screen bg-white">
      ...
      {event.banner && (
        <div className="container-x pb-8">
          <div className="overflow-hidden border border-black/10">
            <img src={event.banner} alt={event.title} className="h-48 w-full object-cover md:h-72" />
          </div>
        </div>
      )}
      ...
      <div className="container-x pb-20">
        <div className="grid gap-12 lg:grid-cols-[1fr_360px]">
          ...
          <div>
            {/* Title */}
            <h1 className="font-mono text-4xl font-black leading-tight tracking-tighter text-black md:text-5xl">
              {event.title}
            </h1>
            ...
            <div>
              ...
              <p className="mt-4 text-sm leading-relaxed text-ink-soft">
                {event.description || event.shortDescription || 'No additional details provided.'}
              </p>
            </div>
          </div>
